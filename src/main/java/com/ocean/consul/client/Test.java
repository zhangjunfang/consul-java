package com.ocean.consul.client;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		keyValuesReponse.getValue().forEach(value -> System.out.println(value.getKey() + ": " + value.getDecodedValue())); // prints "com.my.app.foo: foo" and "com.my.app.bar: bar"
...
//		client.agentServiceRegister(newService);
		...
		healthyServices.getConsulLastContact();
